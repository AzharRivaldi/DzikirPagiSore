...
import com.azhar.doapagisore.view.ViewPagerAdapterPG;
...
public class PagiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager = (ViewPager)findViewById(R.id.pagi);

        adapter = new ViewPagerAdapterPG(PagiActivity.this,judul,keteranganarab,keteranganindo);
